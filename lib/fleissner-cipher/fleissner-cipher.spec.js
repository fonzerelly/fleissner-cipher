...
describe('fleissner-cipher', () => {
    describe('createMatrix', () => {
        ...
        describe('resulting matrix of size 6', () => {
            ...
            const forEachCell = (action, matrix) => {
                forEach((row) => {
                    forEach((col) => {
                        action(col)
                    }, row)
            ...
            it('should return a boolean array, which rotations are not overlapping', () => {
                ...
                const threeQuarters = mapMatrix(or, half, by180)
                const complete = mapMatrix(or, threeQuarters, by270)
                forEachCell((cell) => {
    ...
    describe('encrypt', () => {
        ...
        it('should position chars extending key quarter triple size at 180 degrees', () => {
        ...
        it('should position chars that exceed complete keysize in another square', () => {
